...
zooAnimals.forEach(animal => {
  animalNames.push (`Name: ${animal.animal_name} ${animal.scientific_name}`);
});
...
const lowerPopulation = zooAnimals.filter(populationLessThan5 => {
  return populationLessThan5.population < 5;
})
